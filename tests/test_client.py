...
class Client:
    ...
    def tearDown(self):
        """Tear down the Client class tests."""
    ...
    def test_list_products(self):
        """Test the list_products method of the Client class."""
        products = self.client.list_products()
        assert products is not None

    def test_get_product(self):
        """Test the get_product method of the Client class."""
    ...
    def test_get_position(self):
        ...
        print(f"{position=}")
        self.client.create_order(**TEST_MARKET_BUY)
    ...
    def test_get_orders(self):
        """Test the get_orders method of the Client class (https://100x.readme.io/reference/list-orders-trade)."""
        self.client.login()
    ...
    def test_order_decimal_number_quantity(self):
        """Test the order method of the Client class."""
        self.client.login()
        order = self.client.create_order(**TEST_ORDER_DECIMAL_QUANTITY)
        assert order is not None

    def test_order_decimal_number_price(self):
        """Test the order method of the Client class."""
        self.client.login()
        order = self.client.create_order(**TEST_ORDER_DECIMAL_PRICE)
        assert order is not None

    def test_order(self):
        """Test the order method of the Client class."""
        self.client.login()
        order = self.client.create_order(**TEST_ORDER)
        assert order is not None
